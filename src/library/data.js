  ...
  getContract: ({ total, paymentInfo }) => ({
    ...
    lv1Terms: [
      ...
      },
      {
        ...
        lv2Terms: [
          {
            lv3Title: `本合約簽訂時，支付本軟體報酬總額的 ${paymentInfo[0].percent} %，計 ${ntcw.toWords(paymentInfo[0].price)} 元整(含稅)。`,
          },
          {
            lv3Title: `乙方提交本軟體試作版本予甲方時，經甲方確認主要功能無誤後，支付本軟體報酬總額的 ${paymentInfo[1].percent} %，計 ${ntcw.toWords(paymentInfo[1].price)} 元整(含稅)。`,
          },
          {
            lv3Title: `乙方提交本軟體予甲方時，支付本軟體報酬總額的 ${paymentInfo[2].percent} %，計 ${ntcw.toWords(paymentInfo[2].price)} 元整(含稅)。`,
          },
          {
            lv3Title: `本軟體經甲方驗收無誤後，支付報酬總額的 ${paymentInfo[3].percent} %，計 ${ntcw.toWords(paymentInfo[3].price)} 元整(含稅)。`,
          },
        ],
      },
      {
